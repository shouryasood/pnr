...
locals {
  ...
  local_network_peering      = "${local.local_network_name}-${local.peer_network_name}-${var.suffix}"
  ...
  peer_network_peering       = "${local.peer_network_name}-${local.local_network_name}-${var.suffix}"
